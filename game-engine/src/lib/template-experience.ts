...
export const TEMPLATE_EXPERIENCES: Record<GameVisualTemplate, TemplateExperience> = {
  ...
  'neo-brutal': {
    home: { layout:'build-board', eyebrow:'BUILD YOUR WAY', journeyKicker:'BUILD BOARD', journeyTitle:'挑戰拼裝板', journeyUnit:'塊', journeyLink:'查看拼裝板', currentKicker:'NEXT PIECE', currentTitle:'下一塊挑戰', recordTitle:'完成零件盒', emptyRecord:'完成第一塊挑戰後，成果會放進零件盒。', completeTitle:'作品組裝完成！', completeMessage:'把每一塊解法重新排列，看看還能組出什麼方法。', footerCode:'BREAK · BUILD · TEST', footerMessage:'拆小問題，親手拼出完整解法。', stopLabel:sequence('積木','底板 · 快速導覽','成品 · 最終組裝') },
  ...
  arcade: {
    home: { layout:'level-select', eyebrow:'PLAYER ONE · READY', journeyKicker:'LEVEL SELECT', journeyTitle:'選關畫面', journeyUnit:'關', journeyLink:'前往選關', currentKicker:'CONTINUE', currentTitle:'繼續遊戲', recordTitle:'破關紀錄', emptyRecord:'完成第一關後，破關紀錄會顯示在這裡。', completeTitle:'ALL STAGES CLEAR!', completeMessage:'重玩關卡並比較不同策略，刷新自己的解題紀錄。', footerCode:'READY · THINK · CLEAR', footerMessage:'讀懂規則，找到突破口，完成破關。', stopLabel:sequence('STAGE','教學關 · TUTORIAL','BOSS STAGE') },
  ...
  'forest-camp': {
    home: { layout:'trail', eyebrow:'TODAY’S TRAIL', journeyKicker:'TRAIL GUIDE', journeyTitle:'學習步道路線', journeyUnit:'處路標', journeyLink:'查看今日路線', currentKicker:'NEXT STOP', currentTitle:'下一個停靠點', recordTitle:'旅程手帳', emptyRecord:'走過第一個路標後，足跡會記進旅程手帳。', completeTitle:'抵達今日終點！', completeMessage:'在營火旁回想沿途線索，說說你是怎麼找到方向的。', footerCode:'NOTICE · FOLLOW · REFLECT', footerMessage:'不趕路，把每一步的發現帶回營地。', stopLabel:sequence('路標','登山口 · 行前準備','山頂 · 最終挑戰') },
  ...
  'arcane-archive': {
    home: { layout:'chapter-index', eyebrow:'OPEN THE NEXT CHAPTER', journeyKicker:'TABLE OF CONTENTS', journeyTitle:'典藏章節索引', journeyUnit:'章', journeyLink:'翻閱章節', currentKicker:'BOOKMARKED', currentTitle:'目前閱讀章節', recordTitle:'已解鎖典藏', emptyRecord:'解開第一章後，知識會收進你的典藏。', completeTitle:'全卷典藏完成！', completeMessage:'重新翻閱關鍵章節，將散落的知識串成自己的理解。', footerCode:'READ · DECODE · ARCHIVE', footerMessage:'翻開線索，解開章節，收藏真正理解的知識。', stopLabel:(role, number) => role === 'intro' ? '序章 · 入館指引' : role === 'final' ? '終章 · 大試煉' : `第 ${String(number).padStart(2, '0')} 章` },
  ...
  'orbital-lab': {
    home: { layout:'mission-control', eyebrow:'MISSION CONTROL ONLINE', journeyKicker:'FLIGHT PLAN', journeyTitle:'任務控制中心', journeyUnit:'個模組', journeyLink:'開啟任務控制', currentKicker:'ACTIVE MODULE', currentTitle:'目前任務模組', recordTitle:'任務遙測紀錄', emptyRecord:'完成第一個模組後，驗證資料會寫入遙測紀錄。', completeTitle:'任務航程完成！', completeMessage:'檢查研究紀錄，確認每個結論都有資料與推理支持。', footerCode:'SCAN · HYPOTHESIZE · VERIFY', footerMessage:'讀取資料，建立假設，用證據完成驗證。', stopLabel:sequence('模組','發射前檢查','最終航段') },
